...
export default function BuyerDashboard() {
  ...
  async function fetchTransactions() {
    try {
      ...
      const res = await fetch(`${apiBaseUrl}/api/transactions`, {
        headers: {
          "X-User-Id": "00000000-0000-0000-0000-000000000001", // Demo buyer ID
          "X-User-Role": "BUYER",
        },
      });
  ...
  return (
    <main style={{ padding: "40px 20px", maxWidth: 1200, margin: "0 auto" }}>
      <h1 style={{ fontSize: "2.5rem", marginBottom: 30 }}>Buyer Dashboard</h1>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "start", marginBottom: 15 }}>
                <div>
                  ...
                  <p style={{ margin: 0, fontSize: "0.9rem", color: "#666" }}>
                    Seller ID: {tx.sellerId.substring(0, 8)}...
                  </p>
                </div>
                <span
                  style={{
                ...
                <div>
                  <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 8 }}>
                    ...
                    <span style={{ fontSize: "0.9rem", fontWeight: "600" }}>
                      {calculateProgress(tx.milestones).toFixed(0)}%
                    </span>
                  </div>
                  <div
                    style={{
                  ...
                  >
                    <div
                      style={{
                        width: `${calculateProgress(tx.milestones)}%`,
                        height: "100%",
